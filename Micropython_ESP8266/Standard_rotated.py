#Fonts from https://www.min.at/prinz/o/software/pixelfont/
#Font name:Standard and rotated once.
#exported as c header and made python compatible
# Font: Standard.pf
...
fonts = (
	...
	0x1E, 0xBF, 0xA1, 0xE1, 0x61, 0x33, 0x12, 0x00,	# Char 128 (.)
	0x3D, 0x7D, 0x40, 0x40, 0x3D, 0x7D, 0x40, 0x00,	# Char 129 (.)
	0x38, 0x7C, 0x54, 0x56, 0x55, 0x5D, 0x19, 0x00,	# Char 130 (.)
	0x22, 0x71, 0x55, 0x55, 0x3D, 0x79, 0x42, 0x00,	# Char 131 (.)
	0x21, 0x75, 0x54, 0x54, 0x3D, 0x79, 0x40, 0x00,	# Char 132 (.)
	0x21, 0x75, 0x55, 0x56, 0x3C, 0x78, 0x40, 0x00,	# Char 133 (.)
	0x20, 0x74, 0x57, 0x57, 0x3C, 0x78, 0x40, 0x00,	# Char 134 (.)
	0x18, 0xBC, 0xA4, 0xE4, 0x64, 0x24, 0x00, 0x00,	# Char 135 (.)
	0x3A, 0x7D, 0x55, 0x55, 0x55, 0x5D, 0x1A, 0x00,	# Char 136 (.)
	0x39, 0x7D, 0x54, 0x54, 0x54, 0x5D, 0x19, 0x00,	# Char 137 (.)
	0x39, 0x7D, 0x55, 0x56, 0x54, 0x5C, 0x18, 0x00,	# Char 138 (.)
	0x00, 0x01, 0x45, 0x7C, 0x7C, 0x41, 0x01, 0x00,	# Char 139 (.)
	0x02, 0x01, 0x45, 0x7D, 0x7D, 0x41, 0x02, 0x00,	# Char 140 (.)
	0x01, 0x01, 0x45, 0x7E, 0x7C, 0x40, 0x00, 0x00,	# Char 141 (.)
	0x79, 0x7D, 0x14, 0x14, 0x14, 0x7D, 0x79, 0x00,	# Char 142 (.)
	0x78, 0x7C, 0x17, 0x17, 0x17, 0x7C, 0x78, 0x00,	# Char 143 (.)
	0x44, 0x7C, 0x7C, 0x56, 0x55, 0x45, 0x45, 0x00,	# Char 144 (.)
	0x20, 0x74, 0x54, 0x7C, 0x54, 0x54, 0x58, 0x00,	# Char 145 (.)
	0x7E, 0x7F, 0x09, 0x09, 0x7F, 0x49, 0x49, 0x00,	# Char 146 (.)
	0x3A, 0x7D, 0x45, 0x45, 0x45, 0x7D, 0x3A, 0x00,	# Char 147 (.)
	0x39, 0x7D, 0x44, 0x44, 0x44, 0x7D, 0x39, 0x00,	# Char 148 (.)
	0x39, 0x7D, 0x45, 0x46, 0x44, 0x7C, 0x38, 0x00,	# Char 149 (.)
	0x3E, 0x7D, 0x41, 0x41, 0x3D, 0x7D, 0x42, 0x00,	# Char 150 (.)
	0x3D, 0x7D, 0x41, 0x42, 0x3C, 0x7C, 0x40, 0x00,	# Char 151 (.)
	0x9D, 0xBD, 0xA0, 0xA0, 0xFD, 0x7D, 0x00, 0x00,	# Char 152 (.)
	0x3D, 0x7F, 0x42, 0x42, 0x42, 0x7F, 0x3D, 0x00,	# Char 153 (.)
	0x3D, 0x7D, 0x40, 0x40, 0x40, 0x7D, 0x3D, 0x00,	# Char 154 (.)
	0x1C, 0x3E, 0x22, 0x7F, 0x63, 0x36, 0x14, 0x00,	# Char 155 (.)
	0x68, 0x7E, 0x3F, 0x69, 0x43, 0x42, 0x20, 0x00,	# Char 156 (.)
	0x00, 0x29, 0x2B, 0x7E, 0x7E, 0x2B, 0x29, 0x00,	# Char 157 (.)
	0x7F, 0x7F, 0x05, 0x25, 0x77, 0xFA, 0xA0, 0x00,	# Char 158 (.)
	0x40, 0xC0, 0x88, 0xFE, 0x7F, 0x09, 0x03, 0x02,	# Char 159 (.)
	0x20, 0x74, 0x54, 0x56, 0x3D, 0x79, 0x41, 0x00,	# Char 160 (.)
	0x00, 0x00, 0x44, 0x7E, 0x7D, 0x41, 0x01, 0x00,	# Char 161 (.)
	0x38, 0x7C, 0x44, 0x46, 0x45, 0x7D, 0x39, 0x00,	# Char 162 (.)
	0x3C, 0x7C, 0x40, 0x42, 0x3D, 0x7D, 0x41, 0x00,	# Char 163 (.)
	0x06, 0x7D, 0x79, 0x06, 0x06, 0x7D, 0x79, 0x00,	# Char 164 (.)
	0x7E, 0x7D, 0x0D, 0x1A, 0x32, 0x7D, 0x7D, 0x00,	# Char 165 (.)
	0x00, 0x20, 0x2D, 0x2D, 0x27, 0x2E, 0x20, 0x00,	# Char 166 (.)
	0x00, 0x26, 0x2F, 0x29, 0x2F, 0x26, 0x00, 0x00,	# Char 167 (.)
	0x30, 0x78, 0x4D, 0x45, 0x40, 0x70, 0x30, 0x00,	# Char 168 (.)
	0x38, 0x38, 0x08, 0x08, 0x08, 0x08, 0x00, 0x00,	# Char 169 (.)
	0x08, 0x08, 0x08, 0x08, 0x38, 0x38, 0x00, 0x00,	# Char 170 (.)
	0x2F, 0x1F, 0x08, 0x4C, 0x6A, 0x78, 0x58, 0x00,	# Char 171 (.)
	0x2F, 0x1F, 0x28, 0x34, 0x7A, 0x78, 0x20, 0x00,	# Char 172 (.)
	0x00, 0x00, 0x30, 0x7D, 0x7D, 0x30, 0x00, 0x00,	# Char 173 (.)
	0x08, 0x1C, 0x36, 0x2A, 0x1C, 0x36, 0x22, 0x00,	# Char 174 (.)
	0x22, 0x36, 0x1C, 0x2A, 0x36, 0x1C, 0x08, 0x00,	# Char 175 (.)
	0xAA, 0x00, 0x55, 0x00, 0xAA, 0x00, 0x55, 0x00,	# Char 176 (.)
	0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55, 0xAA, 0x55,	# Char 177 (.)
	0xDD, 0xFF, 0xAA, 0x77, 0xDD, 0xAA, 0xFF, 0x77,	# Char 178 (.)
	...
	0x38, 0x7C, 0x44, 0x64, 0x38, 0x6C, 0x40, 0x00,	# Char 224 (.)
	0x7E, 0xFF, 0x01, 0x45, 0x4F, 0x7A, 0x30, 0x00,	# Char 225 (.)
	0x41, 0x7F, 0x7F, 0x41, 0x01, 0x01, 0x03, 0x00,	# Char 226 (.)
	0x08, 0x7C, 0x3C, 0x04, 0x7C, 0x3C, 0x06, 0x00,	# Char 227 (.)
	0x41, 0x63, 0x77, 0x5D, 0x49, 0x41, 0x63, 0x00,	# Char 228 (.)
	0x38, 0x7C, 0x44, 0x4C, 0x34, 0x04, 0x04, 0x00,	# Char 229 (.)
	0xFC, 0x7C, 0x40, 0x40, 0x7C, 0x3C, 0x00, 0x00,	# Char 230 (.)
	0x08, 0x0C, 0x04, 0x7C, 0x3C, 0x04, 0x04, 0x00,	# Char 231 (.)
	0x18, 0x3C, 0xA5, 0xFF, 0xA5, 0x3C, 0x18, 0x00,	# Char 232 (.)
	0x3E, 0x7F, 0x49, 0x49, 0x49, 0x7F, 0x3E, 0x00,	# Char 233 (.)
	0x4E, 0x5F, 0x71, 0x01, 0x71, 0x5F, 0x4E, 0x00,	# Char 234 (.)
	0x30, 0x78, 0x4B, 0x4D, 0x7D, 0x39, 0x02, 0x00,	# Char 235 (.)
	0x18, 0x24, 0x24, 0x18, 0x18, 0x24, 0x24, 0x18,	# Char 236 (.)
	0x58, 0x74, 0x34, 0x3C, 0x2C, 0x2E, 0x1A, 0x00,	# Char 237 (.)
	0x38, 0x7C, 0x54, 0x54, 0x54, 0x44, 0x00, 0x00,	# Char 238 (.)
	0x7C, 0x7E, 0x02, 0x02, 0x02, 0x7E, 0x7C, 0x00,	# Char 239 (.)
	0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x00,	# Char 240 (.)
	0x00, 0x44, 0x44, 0x5F, 0x5F, 0x44, 0x44, 0x00,	# Char 241 (.)
	0x00, 0x40, 0x51, 0x5B, 0x4E, 0x44, 0x00, 0x00,	# Char 242 (.)
	0x00, 0x44, 0x4E, 0x5B, 0x51, 0x40, 0x00, 0x00,	# Char 243 (.)
	0x00, 0x00, 0x00, 0xFE, 0xFF, 0x01, 0x07, 0x06,	# Char 244 (.)
	0x60, 0xE0, 0x80, 0xFF, 0x7F, 0x00, 0x00, 0x00,	# Char 245 (.)
	0x00, 0x08, 0x08, 0x2A, 0x2A, 0x08, 0x08, 0x00,	# Char 246 (.)
	0x24, 0x36, 0x12, 0x36, 0x24, 0x36, 0x12, 0x00,	# Char 247 (.)
	0x00, 0x02, 0x07, 0x05, 0x07, 0x02, 0x00, 0x00,	# Char 248 (.)
	0x00, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00,	# Char 249 (.)
	0x00, 0x00, 0x00, 0x10, 0x10, 0x00, 0x00, 0x00,	# Char 250 (.)
	0x10, 0x30, 0x70, 0x40, 0x7F, 0x7F, 0x01, 0x01,	# Char 251 (.)
	0x01, 0x0F, 0x0E, 0x01, 0x0F, 0x0E, 0x00, 0x00,	# Char 252 (.)
	0x0D, 0x0D, 0x0B, 0x0B, 0x00, 0x00, 0x00, 0x00,	# Char 253 (.)
